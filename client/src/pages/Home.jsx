...
import { MapPin, Phone, Mail, Wifi, Coffee, Shield, Wind, Camera } from 'lucide-react';
    ...
    return (
        <div className="home">
            ...
            <section id="rooms" className="section container">
                <div className="grid-3" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', alignItems: 'center' }}>
                    <div>
                        <img src="/assets/room.png" alt="Room" style={{ width: '100%', borderRadius: '20px', boxShadow: 'var(--shadow)' }} />
                    </div>
                    <div>
                        <h2>Cozy Rooms</h2>
                        <p className="mt-4">
