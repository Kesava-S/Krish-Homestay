    ...
    return (
        <div className="home">
            ...
            <section id="attractions" className="section container">
                <h2 className="text-center mb-5">Nearby Attractions</h2>
                <div className="grid-3">
                    <div className="glass-card">
            ...
            <section id="policies" className="section" style={{ background: 'var(--bg-light)' }}>
                <div className="container">
                    <h2 className="text-center mb-5">Homestay Policies</h2>
                    <div className="grid-3">
                        <div className="glass-card">
            ...
            <section id="gallery" className="section" style={{ background: 'white' }}>
                <div className="container">
                    ...
                    <div className="gallery-grid" style={{
                        ...
                        {/* Images */}
                        <img src="/assets/gallery_1.jpg" alt="Living Area" style={{ width: '100%', height: '300px', objectFit: 'cover', borderRadius: '10px', transition: 'transform 0.3s' }} className="gallery-item" />
                        <img src="/assets/gallery_2.jpg" alt="Balcony View" style={{ width: '100%', height: '300px', objectFit: 'cover', borderRadius: '10px' }} className="gallery-item" />
                        <img src="/assets/gallery_3.jpg" alt="Balcony Seating" style={{ width: '100%', height: '300px', objectFit: 'cover', borderRadius: '10px' }} className="gallery-item" />
                        <img src="/assets/gallery_4.jpg" alt="Parking & Entrance" style={{ width: '100%', height: '300px', objectFit: 'cover', borderRadius: '10px' }} className="gallery-item" />
                        <img src="/assets/gallery_5.jpg" alt="Outdoor Dining" style={{ width: '100%', height: '300px', objectFit: 'cover', borderRadius: '10px' }} className="gallery-item" />
